...
<body>
	<div class="wrapper">
		...
		<div class="jumbotron jumbotron-fluid">
			<div class="container">
				<h2 class="jumbotron-title">Your health is our priority</h2>
				<p>Start booking appointment with ClinicMe now</p>
			</div>
		</div>
			...
			<div class="container">
				<div class="row slideanim">
					<div class="col-6 col-md-4">
						...
						<div class="desc">
							<h4 class="mb-3">No hassle</h4>
							<p class="paragraph">
							Your time is valuable, and we're committed to providing a seamless experience 
							from start to finish, 
							ensuring you can focus on what matters most – your health and well-being
							</p>
						</div>
					</div>
					<div class="col-6 col-md-4">
						...
						<div class="desc">
							...
							<p class="paragraph">
							Our services are available at your fingertips, 
							no matter where you are or when you need them. 
							Enjoy the freedom to book appointments and manage your healthcare on your own terms, 24/7
							</p>
						</div>
					</div>
					<div class="col-6 col-md-4">
						...
						<div class="desc">
							...
							<p class="paragraph">
							Take charge of your well-being with easy-to-use tools and personalized insights. 
							Monitor your progress, set goals, and 
							make informed decisions for a healthier, happier you
							</p>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">Handle clinics and add new admin with admin features.
								</p>
					...
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text"> Register with us and have the control to doctors and patients.
								</p>
					...
					<div class="col-sm-4">
						<div class="card">
							<div class="card-body">
								...
								<p class="card-text">Manage schedule and appointments with a click.
								</p>
			...
			<div id="carouselContent" class="carousel slide" data-ride="carousel">
				<div class="carousel-inner text-center" role="listbox">
					<div class="carousel-item active">
						...
						<p>Quick and convenient! No long wait times or complicated steps</p>
						<div class="quote">
							<p><strong>- Luqman Bakhtiar</strong><br>Engineer</p>
						</div>
					</div>
					<div class="carousel-item">
						<div class="avatar"><img
								src="https://img.icons8.com/color/48/000000/circled-user-female-skin-type-7.png"></div>
						<p>It's so easy to use and I was able to secure an appointment that fit my schedule perfectly</p>
						<div class="quote">
							<p><strong>- Rebecca Lee</strong><br>Teacher</p>
						</div>
					</div>
				</div>
